...
const Banner = () => {
    // hero  min-h-screen
    return (
        <div className="p-8 my-2 shadow-2xl rounded-md" style={{ backgroundImage: `url("https://images.unsplash.com/photo-1618842676088-c4d48a6a7c9d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80")`, backgroundSize: 'cover' }}>
             <NavBar></NavBar>
